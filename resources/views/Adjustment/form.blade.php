...
<head>
    <title>Adjustment Assessment</title>
    <style>
...
<body>
    <div class="container">
        <h1>Adjustment Assessment</h1>
        <form id="adjustment-form" action="/adjustment-answers" method="POST">
            @csrf
            <div id="step-1">
        ...
        <div class="footer">
            &copy; 2024 Adjustment Assessment. All rights reserved.
        </div>
    </div>
